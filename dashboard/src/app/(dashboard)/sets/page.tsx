...
export default async function SetsPage() {
  ...
  // Sub-sets whose cards are already included in the parent set
  const HIDDEN_SUBSETS = new Set([
                ...
                <div className="relative overflow-hidden rounded-xl border border-border group transition-all hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5">
                  ...
                  {set.top_card_image_url ? (
                    <img
                      ...
                      alt=""
                      className="absolute inset-0 w-full h-full object-cover object-[center_20%] blur-[1px] scale-105 opacity-40 transition-all duration-500 ease-out group-hover:opacity-55 group-hover:scale-110"
                    />
                  ) : (
                  ...
                  <div className="relative z-10 p-5 min-h-[200px] flex flex-col">
                    ...
                    <div className="flex items-start justify-between mb-auto">
                      ...
                      {set.code && (
                        <Badge
                          variant="outline"
                          className="ml-2 text-[10px] uppercase flex-shrink-0 border-white/20 text-white/70"
                        >
                          {set.code}
                        </Badge>
                      )}
