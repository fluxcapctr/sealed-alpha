-- Migration 009b: Add sales metrics columns + recreate view with correct schema
-- Run this in Supabase SQL Editor (each statement separately if needed)

-- Step 1: Add sales metrics columns to products table
...
-- This matches the ACTUAL current schema plus new sales columns
